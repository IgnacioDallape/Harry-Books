...
const NavBar = () => {
    ...
    return (
        ...
        <div   onMouseOver={handleMouseEnter} onMouseLeave={handleMouseLeave} style={{display:'flex',flexDirection:'column',justifyContent:'center',position:'absolute', right:'1rem', top:'2rem', width:'18rem', cursor:'pointer'}} >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-cart aumentoImg" viewBox="0 0 16 16" style={{backgroundColor:'black', borderRadius:'0.2rem', position:'relative', left:'2rem'}} >
